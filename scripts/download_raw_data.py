...
urls_fns_dict = {
    "USPTO_DIVERSE": [
        ("https://drive.google.com/uc?id=1lK5r6IdId2khzP8g_ok_TtGNq45eNXva", "src-train.txt"),
        ("https://drive.google.com/uc?id=1GA2-GRaaO_G6ZhO-vbgAXjTeBLMtuDrH", "tgt-train.txt"),
        ("https://drive.google.com/uc?id=13xB68GfinjeFw58omG0WCFrl8QlTsZtv", "src-val.txt"),
        ("https://drive.google.com/uc?id=1Gy5upUwvoJCyftUCycbo7jDFJsW_VqeE", "tgt-val.txt"),
        ("https://drive.google.com/uc?id=1fGZudxMy3dftmaJZBK8ZiodojyjKVjYc", "src-test.txt"),
        ("https://drive.google.com/uc?id=1UunYH61-qaHJYMHKhehdMCwfqa6doa-J", "tgt-test.txt")
    ],
    "USPTO_50k": [
...
def parse_args():
    ...
    parser.add_argument("--data_name", help="data name", type=str, default="",
                        choices=["USPTO_50k", "USPTO_full", "USPTO_480k", "USPTO_STEREO", "USPTO_DIVERSE"])

...
def add_train_args(parser):
    ...
    #++++++++++++++++++++ Variational decoder
    group.add_argument("--latent_K", help="Discrete latent size", type=int, default=30)
    group.add_argument("--variational_num_layers", help="No. of layers in variational decoder", type=int, default=1)
    group.add_argument("--latent_size", help="Decoder latent size", type=int, default=60)
    group.add_argument("--varFFN_hidden_size", help="Decoder VarFeedForward hidden size", type=int, default=128)
    # -------------- Transformer decoder ---------------
    ...
    group.add_argument("--keep_last_ckpt", help="No. of steps remaining", type=int, default=10)
    # debug params
